  ...
  <body>
    ...
    <div class = "menu">
      ...
      <div class = "tabla_gestion">
        <table>
            <form action = "InsertarDestinoAL.php" method = "POST" enctype = "multipart/form-data">
              <tr><th style = "text-align: right">Nombre</th> <td><input type = "text" name = "nombre" required></td></tr>
              ...
              <tr><th style = "text-align: right">Descripcion</th> <td><input type = "text" name = "descripcion" required></td></tr>
              <tr><th style = "text-align: right">Imagen (PNG)</th> <td><input type = "file" name = "url" class = "anadir" required></td></tr>
